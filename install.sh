...
installTheme(){
    ...
    git clone https://github.com/seggafalmudhary/MinecraftPurpleTheme.git
...
repair(){
    bash <(curl https://raw.githubusercontent.com/seggafalmudhary/MinecraftPurpleTheme/main/repair.sh)
}
